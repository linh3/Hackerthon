    ...
    public sealed class MockDataStore : IDataStore
    {
        ...
        public MockDataStore()
        {
            ...
            var mockHeroes = new List<Hero>
            {
                ...
                new Hero { Id = Guid.NewGuid().ToString(), Name = "Seven Hero", ImageLink="An image link to Hero7." , Level = 3},
            ...
            {
                new Monster { Id = Guid.NewGuid().ToString(), Name = "First Monster", ImageLink="This is the image link for Monster 1", Level = 5 },
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Second Monster", ImageLink="This is the image link for Monster 2", Level = 20 },
                ...
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Seven Monster", ImageLink="This is the image link for Monster 7", Level = 20 },
